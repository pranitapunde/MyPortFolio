...
const Project = () => {
    ...
    return (
        ...
        id='project'
            ...
            <div className=" project-sec max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full items-center">
                <div className="pb-8">
                ...
                <div className="projectCard grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0">
